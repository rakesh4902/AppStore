...
class AppStore extends Component {
  ...
  filterApps = filteredSearch => {
    const {activeTabId} = this.state
    const filteredApps = filteredSearch.filter(
  ...
  filterSearch = () => {
    ...
    const filteredSearch = appsList.filter(eachApp =>
  ...
  render() {
    ...
    const filterApps = this.filterApps(filteredSearch)
